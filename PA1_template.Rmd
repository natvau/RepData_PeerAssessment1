...
```{r}
intervals <- unique(data$interval)
meanIntervalWeekday <- sapply(X = intervals, function(x) mean(data[c(data$interval==x, data$day=="weekday"),'steps'], na.rm = TRUE))
meanIntervalWeekend <- sapply(X = intervals, function(x) mean(data[c(data$interval==x, data$day=="weekend"),'steps'], na.rm = TRUE))
names(meanIntervalWeekday) = names(meanIntervalWeekend) <- intervals
par(mfrow=c(2,1))
plot(names(meanIntervalWeekday), meanInterval, type="l", ylab="Average number of steps", xlab="Interval", main = "Weekday")
plot(names(meanIntervalWeekend), meanInterval, type="l", ylab="Average number of steps", xlab="Interval", main = "Weekend")
