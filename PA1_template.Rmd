...
names(meanInterval) <- intervals
par(mfrow=c(2,1))
plot(names(meanInterval), meanInterval, type="l", ylab="Average number of steps", xlab="Interval", main="Weekday")
...
names(meanInterval) <- intervals
plot(names(meanInterval), meanInterval, type="l", ylab="Average number of steps", xlab="Interval", main="Weekend")
````